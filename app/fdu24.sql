...
--
-- Host: 127.0.0.1
-- Generation Time: 2016 年 8 朁E30 日 15:38
...
(2, 'アニメ好き', '0', '2016-06-29 02:03:21', '2016-06-29 02:03:21'),
...
(9, '歌う事好き', '0', '2016-08-17 21:15:11', '2016-08-17 21:15:11'),
(10, '旅行好き', '0', '2016-08-17 21:15:28', '2016-08-17 21:15:28'),
(11, '絵が得意', '0', '2016-08-17 21:15:34', '2016-08-17 21:15:34'),
(12, 'パソコン得意', '0', '2016-08-17 21:15:53', '2016-08-17 21:15:53'),
(13, '運転得意', '0', '2016-08-17 21:16:04', '2016-08-17 21:16:04'),
(15, '写真が得意', '0', '2016-08-17 21:16:29', '2016-08-17 21:16:29'),
(16, '料理が得意', '0', '2016-08-17 21:16:37', '2016-08-17 21:16:37'),
(17, '勉強得意', '0', '2016-08-17 21:16:46', '2016-08-17 21:16:46');
...
(441, 25, 'Profession', 'dj.jpg', 'http://localhost/fdu24/app/webroot/files/updir/20160829185639_0.jpeg', 0, '2016-08-29 18:56:43', '2016-08-29 18:56:43'),
...
(16, '1', 1, '1', 'グラフィックデザイナー', 'CDのジャケットや映画のポスターを作る', '専門学校へ行く', '作品集を作る', '作品集を持って面接へ行く', '1,5', '2', '1,2', 'FFFF', '3', '1', '2016-06-29 23:03:31', '2016-08-19 01:11:29'),
(17, '1', 1, '1', 'WEBデザイナー', '映画サイトのデザインをする', '専門学校へ行く', '作ったサイトをネットに公表する', '面接に行く', '1', '1', '1,2', 'FFFF', '1', '0', '2016-06-29 23:06:25', '2016-08-29 19:24:16'),
(18, '1', 1, '1', 'プログラマー', 'ゲームやアプリを作る', '専門学校へ行く', 'ゲームをネットに公開する', '面接する', '1', '1', '1,2', 'FFFF', '2', '0', '2016-06-29 23:08:12', '2016-08-29 19:25:32'),
(19, '1', 2, '1', '彫師', 'スポーツ選手やアーティストの体に一生残る絵を書く', '刺青を入れる', '刺青カルチャーを教わる', '紹介してもらう', '1,5', '1,2,3,4,5,8,11,15,16', '1,2,3,4,5,6,8,9,13,16,19,20,22,24,26,27,29,33,36,37,38,39', 'FFFF', '1', '0', '2016-06-29 23:11:39', '2016-08-29 18:38:55'),
(20, '1', 4, '1', '芸能人のマネージャー', '芸能人という商品を営業する', 'タレントプロダクションに面接に行く', '熱い気持ちを伝える', '断られてももう一度行く', '1', '1,12', '1,13', 'FFFF', '3', '0', '2016-06-29 23:13:47', '2016-08-29 19:18:59'),
...
(25, '1', 1, '1', 'クラブDJ', 'クラブDJはクラブでDJとして音楽を選曲し、音楽を流す職業。\r\nDJにも様々な系統があり、テクノ・ハウス・レゲエ・ヒップホップなど数多くの専門分野があります。', 'クラブで遊ぶ', 'DJと友達になる', '友達主催のイベントに出演させてもらう', '1,5', '1,2,3,4,5,8,12', '1,2,3,6,10,12,19,22,26,27,33,37,38,39', 'FFFF', '1', '0', '2016-06-30 01:25:37', '2016-08-29 18:56:43'),
(26, '1', 1, '1', '映画声優', 'あの映画スターの声になれる', '専門学校行く', '表現力つける', 'オーデションに行く', '1,5', '1,2,3,4,5,6,7,9,11,12', '2,3,4,5,6,7,9,11,12,13,15,19,23,31,34,36,39', 'FFFF', '2', '0', '2016-06-30 02:07:49', '2016-08-29 18:32:29'),
(27, '1', 2, '1', '映画バイヤー', '海外の映画祭などに出かけ、日本でヒットしそうな映画の上映権をオークションや交渉で買い付ける仕事。完成作品の上映を見て買う場合もあれば、脚本の段階で、その内容、監督、出演者などからヒットを予測して買い付ける場合もある。買い付け額は数千万円から数億円。', '映画の配給会社などへ就職', '語学力を磨く', '語学力を磨く', '1,5', '1,2,3,4,5,6,7,8,10,12,17', '1,3,4,5,6,8,10,13,17,19,22,28,29,33,39', 'FFFF', '3', '0', '2016-06-30 21:58:51', '2016-08-29 18:46:32'),
(28, '1', 2, '1', 'ウェディングプランナー', '結婚式場やホテルなどで、結婚式を挙げる新郎様・新婦様の、“挙式・披露宴”をプランニングする仕事・スタッフの事です。', '専門学校', 'おもてなしの心を磨く', '面接へ行く', '1,5', '1,5,6,7,8,9,10,16,17', '1,2,3,6,8,9,10,12,13,17,19,22,28,30,33,38', 'FFFF', '2', '0', '2016-06-30 22:14:47', '2016-08-29 19:03:30'),
(29, '1', 8, '1', 'ストームチェイサー', '竜巻を追跡して映像に記録する専門家。', '竜巻の出る地域をリサーチ', '竜巻の写真を撮る', '竜巻に関する本を出す', '1', '1,4,10,13,15', '3,6,8,13,16,21,26,30,33,37,39', 'FFFF', '4', '0', '2016-06-30 22:25:50', '2016-08-29 19:08:48'),
(30, '1', 1, '1', 'グラフィックデザイナー', 'aaaaaaaaaaaa\r\n\r\naaaaaaaaaaaaaaaa\r\n', 'sfafafasfd', 'asdfasdfadsf', 'afasdfasdfasdf', '1,5', '1,2,3,4,5,6,7,11,12,15,16', '3,6,8,9,13,15,19,22,24,26,27,28,29,31,33,36,37,39', 'http://localhost/fdu24/admin/Professions/add', '0', '0', '2016-08-03 00:14:42', '2016-08-29 18:27:29'),
...
(32, '1', 1, '1', 'グラフィックデザイナーAA', 'デザイン考える', 'ｓだｓｄ', 'だｓだｄ', 'ａｓｄａｓｄａ', '1', '1,2,3', '1,3', 'http://localhost/fdu24/admin/Professions/add', '3', '1', '2016-08-03 00:42:49', '2016-08-21 13:12:24');
